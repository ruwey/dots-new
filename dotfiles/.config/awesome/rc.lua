...
-- The default layout for each tag
local layouts = {
...
globalkeys = {
	...
	awful.key({ modkey }, "-", function() awful.spawn("chVol -5%") end,
			  {description = "decrease volume by 5 through command line", group = "media"}),
	awful.key({ modkey, "Shift" }, "=", function() awful.spawn("chVol +2%") end,
			  {description = "increase volume by 2 through command line", group = "media"}),
	awful.key({ modkey, "Shift" }, "-", function() awful.spawn("chVol -2%") end,
			  {description = "decrease volume by 2 through command line", group = "media"})
}
