...
# Manually Configured with mntns color scheme by Ruwey

base00 = "#091414" # Normal BG
base01 = base00
#base00 = "#173737" # Alt BG
#base00 = "#1c5a4b" # Alt BG
base04 = "#d2cbc7" # Alt FG
base05 = "#fffdf8" # Normal FG
base08 = "#ff3939" # 9
base0A = "#cc9253" # 11
base09 = base0A
base0B = "#94c076" # 10
...
c.tabs.padding = {'bottom': 8, 'left': 0, 'right': 3, 'top': 8}
c.tabs.width = 28
c.tabs.favicons.scale = 1.5

config.bind('tt', 'config-cycle tabs.width 28 15%')
